...
- Открытие исходной ссылки в выбранном браузере, даже после редиректов и переходов в предпросмотре.
- Поддержка профилей Orion.
- Кнопки «Назад» и «Вперёд», жесты трекпада и копирование URL.
- Данные сайтов по умолчанию удаляются после закрытия или скрытия окна превью. По желанию можно сохранять авторизацию и настройки сайтов на этом Mac.
- Настройки разделены на «Основные», «Браузеры», «Данные сайтов» и «О программе». Можно менять порядок браузеров, удалять данные отдельных сайтов и очищать сайты после 7, 30 или 90 дней без посещений.
